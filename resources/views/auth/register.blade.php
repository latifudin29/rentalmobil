            ...
            <h2 class="text-center">FORM REGISTER</h3>
                ...
                <form action="{{route('actionregister')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_handphone" class="form-control" placeholder="Enter No. Handphone" required="">
                    </div>
                    <div class="form-group">
                        <label><i class="fa fa-id-card"></i> SIM</label>
                        <input type="text" name="sim" class="form-control" placeholder="Enter SIM" required="">
                    </div>
                    <div class="form-group">
